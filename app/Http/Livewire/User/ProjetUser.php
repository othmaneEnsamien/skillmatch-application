...
class ProjetUser extends Component
{
    ...
    public function render()
    {
        ...
        // })->get();
        $s = '%' . $this->searchTermC . '%';
        $users = User::where('id', Auth::user()->id)->with('competences')->get();
        ...
        return view('livewire.user.projet-user', compact('users',   'projectss', 'projectss1', 'projets',  'competences'))->layout('layouts.default');
    }
}