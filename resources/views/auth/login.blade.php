        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>se connecter</span></li>
                </ul>
            </div>
            <div class="row">
                            ...
                            <div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('login') }}">
                                    ...
                                    <fieldset class="wrap-title">
                                        <h3 class="form-title" style="font-family: Roboto Slab;">Se connecter</h3>
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                        <label for="frm-login-uname">Email :</label>
                                        <input type="email" id="frm-login-uname" name="email"
                                            placeholder="Votre adresse email" :balue="old('email')" required
                                            autofocus>
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <a class="link-function left-position" href="{{ route('password.request') }}"
                                            title="Forgotten password?">Mot de passe oublié?</a>
                                    </fieldset>
                                    <input type="submit" class="btn btn-submit" value="Login" name="submit" style="background-color :#13404D">
                                </form>
                            </div>
                        </div>
                    </div>
